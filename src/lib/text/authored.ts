...
const OSWALD: AuthoredAlphabet = {
  ...
  // — Stem + bar junctions (uppercase) —
  E: [
    [[0.16, 0.04], [0.16, 0.96]], // stem
    [[0.16, 0.07], [0.82, 0.07]], // top bar
    [[0.16, 0.5], [0.72, 0.5]], // middle bar
    [[0.16, 0.93], [0.84, 0.93]], // bottom bar
  ],
  F: [
    [[0.16, 0.04], [0.16, 0.96]], // stem
    [[0.16, 0.07], [0.82, 0.07]], // top bar
  ...
  H: [
    [[0.14, 0.04], [0.14, 0.96]], // left stem
    [[0.86, 0.04], [0.86, 0.96]], // right stem
    [[0.14, 0.5], [0.86, 0.5]], // crossbar
  ],
  L: [
    [[0.16, 0.04], [0.16, 0.94]], // stem
    [[0.16, 0.93], [0.82, 0.93]], // bottom bar
  ],
  T: [
    [[0.06, 0.07], [0.94, 0.07]], // top bar
    [[0.5, 0.07], [0.5, 0.96]], // stem
  ],
  U: [
    [[0.12, 0.04], [0.12, 0.62]], // left stem
    [[0.14, 0.62], [0.5, 0.95], [0.86, 0.62]], // bottom bowl
    [[0.88, 0.04], [0.88, 0.62]], // right stem
  ],
  G: [
    [[0.86, 0.26], [0.68, 0.08], [0.4, 0.06], [0.18, 0.26], [0.12, 0.5], [0.18, 0.74], [0.4, 0.94], [0.7, 0.92], [0.86, 0.76], [0.86, 0.6]], // C-curve spine
    [[0.6, 0.6], [0.88, 0.6]], // crossbar
  ],
  // — Stem + bowl / bar junctions (lowercase) —
  a: [
    [[0.78, 0.16], [0.78, 1.0]], // right stem
    [[0.76, 0.5], [0.42, 0.46], [0.18, 0.6], [0.2, 0.84], [0.46, 0.97], [0.76, 0.9]], // bowl
  ],
  f: [
    [[0.82, 0.12], [0.58, 0.02], [0.4, 0.1], [0.38, 0.32], [0.38, 1.0]], // curved-top stem
    [[0.14, 0.4], [0.7, 0.4]], // crossbar
  ],
  g: [
    [[0.78, 0.06], [0.78, 0.62], [0.7, 0.82], [0.46, 0.9], [0.22, 0.78], [0.18, 0.6], [0.3, 0.46], [0.6, 0.46], [0.78, 0.56]], // bowl
    [[0.78, 0.1], [0.78, 0.86], [0.62, 1.0], [0.38, 0.98]], // stem + descender tail
  ],
  p: [
    [[0.2, 0.0], [0.2, 1.0]], // stem + descender
    [[0.2, 0.02], [0.56, 0.0], [0.8, 0.2], [0.8, 0.42], [0.56, 0.62], [0.2, 0.6]], // bowl
  ],
  q: [
    [[0.8, 0.0], [0.8, 1.0]], // stem + descender
    [[0.8, 0.02], [0.44, 0.0], [0.2, 0.2], [0.2, 0.42], [0.44, 0.62], [0.8, 0.6]], // bowl
  ],
  t: [
    [[0.45, 0.04], [0.45, 0.84], [0.56, 0.97], [0.74, 0.93]], // stem + foot
    [[0.12, 0.3], [0.78, 0.3]], // crossbar
  ],
  // — Digit with a diagonal junction —
  "7": [
    [[0.08, 0.08], [0.92, 0.08]], // top bar
    [[0.92, 0.08], [0.4, 0.96]], // diagonal
  ],
  // — Digit with a diagonal junction —
  "4": [
